...
import { Trash2, Building2, FolderTree, Target, Globe, Sparkles } from 'lucide-react';
            ...
            <div key={industrySegment} className="border rounded-lg p-6 bg-gradient-to-r from-blue-50 to-indigo-50">
              ...
              <div className="space-y-4">
                {domainGroups.map((domainGroup) => (
                  <div key={domainGroup.id} className="bg-white border rounded-lg p-5 shadow-sm relative">
                    {/* New indicator */}
                    {newlyCreatedIds.has(domainGroup.id) && (
