-- Create comprehensive view for solution seekers data
...
SELECT 
  ...
  ct.name as communication_preference,
...
LEFT JOIN master_communication_types ct ON o.communication_type_id = ct.id
