...
VALUES 
('Platform Usage Fee', 'platform_usage_fee', 'Percentage of solution fee', true),
('Management Fee', 'management_fee', 'Fixed management fee amount', true),
('Consulting Fee', 'consulting_fee', 'Fixed consulting fee amount', true),
('Advance Payment', 'advance_payment', 'Percentage of total fee paid in advance', true)
